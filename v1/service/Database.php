...
class Database
{
    ...
    public static function connectWriteDb()
    {
        if (self::$writeConnDb === null) {
            self::$writeConnDb = new PDO('mysql:dbname=apitask;host=localhost;charset=utf8', 'root', '');
    ...
    public static function connectReadDb()
    {
        if (self::$readConnDb === null) {
            self::$readConnDb = new PDO('mysql:dbname=apitask;host=localhost;charset=utf8', 'root', '');
